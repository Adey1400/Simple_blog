...
function Header() {
  ...
  return (
    <header className="bg-white shadow-md border-b border-gray-200 px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      {user && (
        <nav className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 w-full sm:w-auto justify-center sm:justify-end">
          <span className="text-sm text-gray-700 font-semibold sm:mr-4">
